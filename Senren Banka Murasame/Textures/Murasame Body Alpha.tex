...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Senren Banka Murasame\Textures\Murasame Body Alpha.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>3909597110</m_ExportedTime>
	<m_ClassName text="Leader_OPAC"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Murasame Body Alpha.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Murasame Body Alpha"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
