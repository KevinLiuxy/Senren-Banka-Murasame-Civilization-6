...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Senren Banka Murasame\Textures\FOREGROUND_MURASAME.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1446512341</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="FOREGROUND_MURASAME.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="FOREGROUND_MURASAME"/>
	<m_Description text=""/>
	<m_Tags>
