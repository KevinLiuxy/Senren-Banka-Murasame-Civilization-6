...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Senren Banka Murasame\Textures\Murasame Body Texture.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>2271620447</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Murasame Body Texture.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Murasame Body Texture"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
